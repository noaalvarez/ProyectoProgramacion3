...
public class VentanaFisioterapeuta extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaFisioterapeuta frame = new VentanaFisioterapeuta(null);
	 ...
	 */
	public VentanaFisioterapeuta(VentanaIniciarSes ventanaIniciarSes) {
		...
		JLabel lblProxAct = new JLabel("PRÓXIMA CITA\r\n");
		...
		JLabel lblConDep = new JLabel("Con deportista:");
		lblConDep.setHorizontalAlignment(SwingConstants.CENTER);
		panel_9.add(lblConDep);
		
		JLabel lblClienteObtenido = new JLabel("");
		lblClienteObtenido.setHorizontalAlignment(SwingConstants.CENTER);
		panel_9.add(lblClienteObtenido);
